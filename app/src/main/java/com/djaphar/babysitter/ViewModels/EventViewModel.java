...
public class EventViewModel extends AndroidViewModel {
    ...
    private MutableLiveData<ArrayList<Meal>> selectedMealsMutableLiveData = new MutableLiveData<>();
    private MutableLiveData<ArrayList<Meal>> deniedMealsMutableLiveData = new MutableLiveData<>();
    ...
    public EventViewModel(@NonNull Application application) {
        ...
        parents.add(parent1);
        parents.add(parent2);
        Kid kid1 = new Kid("Мики", "Топ I", "Саяка", "14 лет", "Супер Магическая I",
                "https://cs9.pikabu.ru/post_img/big/2017/05/12/10/1494605959124044472.jpg",
                228, parents,1234);
        Kid kid2 = new Kid("Кёко", "Топ II", "Сакура", "14 лет", "Супер Магическая I",
                "https://cs9.pikabu.ru/post_img/big/2017/05/14/11/1494784894199428054.jpg",
                229, parents,1234);
        Kid kid3 = new Kid("Хомура", "Батя", "Акеми", "14 лет", "Супер Магическая IV",
                "https://www.kindpng.com/picc/m/415-4159860_homura-akemi-magia-record-hd-png-download.png",
                230, parents,1234);
        Kid kid4 = new Kid("Мами", "Отвал Башки", "Томое", "14 лет", "Супер Магическая II",
        ...
        Kid kid5 = new Kid("Мадока", "Пентагон", "Канаме", "14 лет", "Супер Магическая III",
        ...
        ArrayList<Meal> deniedMeals = new ArrayList<>();
        kids.add(kid1);
        kids.add(kid2);
        kids.add(kid3);
        kids.add(kid4);
        ...
        meals.add(meal3);
        meals.add(meal4);
        selectedMeals.add(meal1);
        selectedMeals.add(meal3);
        selectedMeals.add(meal4);
        deniedMeals.add(meal3);
        kidsMutableLiveData.setValue(kids);
        mealsMutableLiveData.setValue(meals);
        selectedMealsMutableLiveData.setValue(selectedMeals);
        deniedMealsMutableLiveData.setValue(deniedMeals);
    }
    ...
    public MutableLiveData<ArrayList<Meal>> getSelectedMeals() {
        return selectedMealsMutableLiveData;
    }

    public MutableLiveData<ArrayList<Meal>> getDeniedMeals() {
